package com.gsrk.threads.cyclicbarrier;
...
public class CyclicBarrierTest {
	...
	public static void main(String[] args) {
		...
		CyclicBarrier barrier1 = new CyclicBarrier(2, barrier2Action);
		CyclicBarrier barrier2 = new CyclicBarrier(2, barrier1Action);
